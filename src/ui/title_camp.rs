...
fn spawn_title_nav_column(parent: &mut ChildBuilder) {
    ...
    parent
        .spawn(NodeBundle {
            ...
            border_color: BorderColor(pal_border),
            ..default()
        })
        .with_children(|col| {
...
fn title_codex_placeholder(parent: &mut ChildBuilder) {
    parent
        .spawn(NodeBundle {
            style: Style {
                width: Val::Percent(100.0),
            ...
            border_color: BorderColor(UiTheme::body_dim()),
            ..default()
        })
        .with_children(|b| {
            b.spawn(TextBundle::from_section(
...
fn spawn_camp_scene(parent: &mut ChildBuilder, meta: &MetaProgression, ph: &UiPlaceholderImages) {
    parent
        .spawn((
            NodeBundle {
                style: Style {
                ...
                background_color: Color::srgba(0.04, 0.04, 0.07, 1.0).into(),
        ...
        .with_children(|scene| {
            scene.spawn(ImageBundle {
                ...
                image: UiImage::new(ph.dungeon_theater.clone())
                    .with_color(Color::srgba(0.35, 0.32, 0.45, 0.35)),
                ..default()
            });
            ...
            scene
                ...
                .with_children(|titles| {
                    titles.spawn(TextBundle::from_section(
                        "DELVERS",
                        TextStyle {
                ...
                .with_children(|camp| {
                    ...
                    camp.spawn((
                        NodeBundle {
                            ...
                            background_color: Color::srgba(0.12, 0.1, 0.08, 0.92).into(),
                    ...
                    .with_children(|figures| {
                        for i in 0..CAMP_FIGURE_SLOTS {
                            ...
                            figures
                                ...
                                .with_children(|fig| {
                                    fig.spawn(TextBundle::from_section(
                                        if i == 0 { "\u{1F9DD}" } else { "\u{2694}" },
                                        TextStyle {
                                            font_size: 42.0,
                                            color: Color::srgba(0.95, 0.82, 0.6, 0.88),
                                            ..default()
                                        },
                                    ));
                    ...
                    .with_children(|fire_zone| {
                        fire_zone.spawn((
                            NodeBundle {
                                ...
                                background_color: Color::srgba(0.95, 0.45, 0.22, 0.45).into(),
                                ..default()
                            },
                            CampfireFlame {
                        ...
                        fire_zone.spawn((
                            NodeBundle {
                                ...
                                background_color: Color::srgba(0.98, 0.55, 0.12, 0.85).into(),
                                ..default()
                            },
                            CampfireFlame {
